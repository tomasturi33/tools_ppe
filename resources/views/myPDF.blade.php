...
<html>
    ...
    <body style="background-image: url('images/pdf/background_pdf.png');background-size: 100%;
        background-repeat: no-repeat;margin: -45px; padding: 80px 100px 140px 80px;font-family: 'Lato', sans-serif; font-size:12px;">
        <div>
            <div class="row">
                <div class="col-12" style="padding:0px!important;">
                    <div class="row">
                        <div class="col-xs-4" align="center">
                            <img src="{{ $photo }}" style="text-align: center;border-radius: 5px;object-fit: none; max-height:200px; max-width: 200px;">
                        </div>
                ...
                <div class="col-12" align="center" style="padding-top: 3rem;">
                    <img src="./images/pdf/divider.png">
                </div>
