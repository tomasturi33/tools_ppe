                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="about_me" name="about_me" rows="5" maxlength="1000">{{ $curriculum->about_me }}</textarea>
                                </div>
                            </div>

                            <div class="col-md-6 col-xs-12">
                                <div class="form-group">
                                    <label>Título academica/profesión:</label>
                                    <input type="text" class="form-control" value="{{ $curriculum->academic_title }}" id="academic_title" name="academic_title" autocomplete="off" required>
                                </div>
                            </div>
