        ...
        <div class="row justify-content-center">
            <div class="col-xl-10">
                <div class="cv-caption text-center pt-4 pb-4">
                    <p style="color: #fff; font-size: 60px;font-weight: 300; text-align: center; box-sizing: border-box;padding-top: 20%; margin-bottom: 0; line-height: normal !important;">CREA TU CV</p>
                </div>
            </div>
        </div>
    </div>
...
<!-- 
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="about_me" name="about_me" rows="9" maxlength="1000" placeholder=""></textarea>
                                        </div>
                                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="img-container">
                        <div class="row">
                            <div class="col-md-8">
                                <img class="image-crop" id="image" src="https://avatars0.githubusercontent.com/u/3456749">
                            </div>
                            <div class="col-md-4">
